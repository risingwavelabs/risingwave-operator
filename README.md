...
2. Copy the [prometheus-remote-write-aws.yaml](https://github.com/risingwavelabs/risingwave-operator/blob/main/monitoring/kube-prometheus-stack/prometheus-remote-write-aws.yaml) file and replace the values of the these variables:
