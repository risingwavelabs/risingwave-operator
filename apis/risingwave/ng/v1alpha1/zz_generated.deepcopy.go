...
func (in *ComponentGroupReplicas) DeepCopyInto(out *ComponentGroupReplicas) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentGroupReplicas.
func (in *ComponentGroupReplicas) DeepCopy() *ComponentGroupReplicas {
	if in == nil {
		return nil
	}
	out := new(ComponentGroupReplicas)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentReplicas) DeepCopyInto(out *ComponentReplicas) {
	*out = *in
	if in.Groups != nil {
		...
		*out = make([]ComponentGroupReplicas, len(*in))
		copy(*out, *in)
	}
}
