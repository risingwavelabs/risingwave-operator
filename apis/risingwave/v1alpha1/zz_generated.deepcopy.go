...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RisingWaveLicense) DeepCopyInto(out *RisingWaveLicense) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RisingWaveLicense.
func (in *RisingWaveLicense) DeepCopy() *RisingWaveLicense {
	if in == nil {
		return nil
	}
	out := new(RisingWaveLicense)
	in.DeepCopyInto(out)
	return out
}
