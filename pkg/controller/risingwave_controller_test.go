	...
	controller := &RisingWaveController{
		...
		ActionHookFactory: func() ctrlkit.ActionHook {
			return newActionAsserts(t, map[string]resultErr{
				...
				RisingWaveAction_SyncFrontendStatefulSets:                    newResultErr(ctrlkit.Continue()),
				...
				RisingWaveAction_SyncFrontendAdvancedStatefulSets:            newResultErr(ctrlkit.Continue()),
				...
				RisingWaveAction_WaitBeforeFrontendStatefulSetsReady:         newResultErr(ctrlkit.Continue()),
				...
				RisingWaveAction_WaitBeforeFrontendAdvancedStatefulSetsReady: newResultErr(ctrlkit.Exit()),
